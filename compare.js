...
function setupOptionsWindow() {
    ...
    themeOptionsContainer.appendChild(createThemeOptionRow({ labelText: "Stats Dash:", storageKey: 'statsDashColor', cssVariable: '--otk-stats-dash-color', defaultValue: '#FFD700', inputType: 'color', idSuffix: 'stats-dash' }));
    ...
    themeOptionsContainer.appendChild(guiBgImageSectionHeading);
    ...
    function getAllOptionConfigs() {
        ...
        return [
            ...
            { storageKey: 'statsDashColor', cssVariable: '--otk-stats-dash-color', defaultValue: '#FFD700', inputType: 'color', idSuffix: 'stats-dash' },
...
async function main() {
    ...
    styleElement.textContent = `
        :root {
            ...
            --otk-stats-dash-color: #e6e6e6; /* For the dashes in the stats display */
